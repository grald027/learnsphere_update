...
const sampleModules: Module[] = [
  {
    ...
    description: 'Study of programming language paradigms, design principles, and implementation strategies including functional, logic, and concurrent programming.',
    files: []
  },
  {
    id: 'CS322',
    ...
    description: 'Software development lifecycle, requirements engineering, design patterns, project management, and team collaboration.',
    files: []
  },
  {
    id: 'CS323',
    ...
    description: 'Ethical and social issues in computing, professional responsibilities, legal aspects, and the impact of technology on society.',
    files: []
  },
  {
    id: 'CS324',
    ...
    description: 'Computer graphics fundamentals, 2D/3D rendering, visual design principles, animation, and visual computing techniques.',
    files: []
  },
  {
    id: 'CS325',
    ...
    description: 'Mobile app development for iOS and Android platforms, UI/UX design, device features, and cross-platform solutions.',
    files: []
  },
  {
    id: 'CS326',
    ...
    description: 'System modeling techniques, discrete and continuous simulation, statistical analysis, and simulation result interpretation.',
    files: []
  },
  {
    id: 'CS327',
    ...
    description: 'Data preprocessing, classification, clustering, association rules, pattern discovery, and data mining algorithms.',
    files: []
  },
  {
    id: 'CS328',
    ...
    description: 'Supervised and unsupervised learning, neural networks, deep learning, model evaluation, and practical ML applications.',
    files: []
  }
];
          ...
          {uploading && (
            <div className="mt-4">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-primary rounded-full h-2 transition-all duration-300" style={{ width: `${uploadProgress}%` }} />
              </div>
            </div>
          )}
        </div>
